...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setPixmap(QtGui.QPixmap("zrn_logo_no_back.png"))
...
"color: rgb(154, 153, 150);")
        ...
        self.label_29.setPixmap(QtGui.QPixmap("test.png"))
